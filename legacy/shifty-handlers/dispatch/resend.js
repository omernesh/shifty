...
// Shared Resend dispatcher for shifty-plugin magic-link invites.
//
...
// own node_modules tree does not contain `resend` symlinks. Same idiom as ./auth/providers.js (co-located).
//
// ====================================================================================
...
//   }
// Our shifty-plugin EmailProvider (auth/providers.js) supplies no per-provider `secret`,
